  ...
  const submitProfile = async () => {
    ...
    try {
      ...
      const applicationData = {
        ...
        // Use the valid status 'completed'. The partner_applications
        // table prohibits arbitrary statuses; previously 'profile_completed'
        // would violate the check constraint and prevent the record from
        // saving.
        status: 'completed',
